...
This command helps you optimize images for the Hugo static site with correct dimensions, formats, and file sizes.
...
```markdown
{{< img src="/images/blog/2025-11-21-post-slug/inline-01.jpg" alt="Descriptive alt text" caption="Optional caption" width="800" >}}
```

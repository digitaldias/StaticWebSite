...
The third leap went to the metal. I wanted smooth Mandelbrot and Julia animations and I did not want the GPU driver to improvise. I asked GPT-5 for a DirectX renderer that kept camera moves smooth and let me swap coloring schemes. It produced a clean command buffer, a small state struct for fractal parameters, and an entry point that handled window events.
